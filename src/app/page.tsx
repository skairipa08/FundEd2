  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        ...
        setFeaturedCampaigns(campaignsData.data || []);
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 leading-relaxed">
              Connect with verified students worldwide who need support to
              complete their education. Every contribution creates lasting
              impact.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600">
              Support verified students making a difference
            </p>
          </div>
          {loading ? (
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-blue-100">
                Students submit their profiles with documents. Our admin team
                verifies every application to ensure authenticity.
              </p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-white/20 backdrop-blur rounded-full mb-4">
              ...
              <p className="text-blue-100">
                Donors browse verified campaigns and contribute any amount.
                Track progress and see real-time impact.
              </p>
            </div>
            <div className="text-center">
              <div className="inline-flex items-center justify-center w-16 h-16 bg-white/20 backdrop-blur rounded-full mb-4">
              ...
              <p className="text-blue-100">
                Students receive funds and complete their education. They share
                their journey and give back to the community.
              </p>
            </div>
          </div>
        </div>
